...
public class InMemoryDatasourceRepository implements DatasourceRepository {
    private static final Logger log = LoggerFactory.getLogger(InMemoryDatasourceRepository.class);
    private final NamedParameterJdbcTemplate jdbcTemplate;
    private final ObjectMapper objectMapper;

    public InMemoryDatasourceRepository(NamedParameterJdbcTemplate jdbcTemplate, ObjectMapper objectMapper) {
